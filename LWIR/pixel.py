...
def pixel(lumapi, model, mat, x=0,y=0,z=0):
...
#Horizontal waveguide    
    waveguide_h= geometry.Rectangle(model)
    ...
    waveguide_h.z_min=z
    waveguide_h.z_max=z+slab_height
    

    
#Vertical waveguide 
    waveguide_v= geometry.Rectangle(model)
    ...
    waveguide_v.z_min=z
    waveguide_v.z_max=z+slab_height
 
#Resonator
    resonator= geometry.Ring(model)
    ...
    resonator.y=y
    resonator.z_min=z
    resonator.z_max=z+slab_height
    
#Absorber
    absorber= geometry.Ring(model)
